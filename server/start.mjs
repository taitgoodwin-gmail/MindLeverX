...
const app = createApp({dbPath:resolve(process.env.MLX_DB_PATH || 'data/mindleverx.sqlite'),seed:process.env.MLX_SEED !== 'false',evidenceInputPath:process.env.MLX_EVIDENCE_INPUT ? resolve(process.env.MLX_EVIDENCE_INPUT) : null,evidenceBrand:process.env.MLX_EVIDENCE_BRAND || 'MindLeverX'});
